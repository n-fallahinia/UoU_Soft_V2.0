...
#define ROT_AXIS -8.0
#define ROT_SCALE 180.0/PI

#if HAVE_GL
class Plot2DView : public Fl_Gl_Window {
#else
class Plot2DView : public Fl_Box {
#endif /* HAVE_GL */
...
public:
    ...
    bool flag_rotation_display;

    Plot2DView(int x,int y,int w,int h,const char *l=0);
...
//
// End of "$Id: Plot2DView.h 5519 2006-10-11 03:12:15Z mike $".
//
