...
Training::Training()
{
	...
	flag_trajectory_ready = 0;
	
	ramp_count = 0;
	ramp_max = 100;//0.1 second
	
	hold_count = 0;
	hold_min = 300;//0.1 second
...
void Training::ReadTrajectoryFile(char* filename)
{
        //File open
        FILE *traj_file;
